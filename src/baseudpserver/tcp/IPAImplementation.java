...
public class IPAImplementation {
    ...
    private static byte[] firstHeaderHand,secondHeaderHand,header;
    ...
    public boolean ipaHandshakeAtServer(Socket socket){
        ...
        try {
            ...
            os.write(Utility.hexStringToByteArray("525453502f312e3020323030204f4b0d0a417564696f2d4a61636b2d5374617475733a20636f6e6e65637465643b20747970653d616e616c6f670d0a435365713a20310d0a0d0a"));
